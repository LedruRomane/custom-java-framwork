...
DROP DATABASE IF EXISTS "catalogue-db";
--
-- Name: catalogue-db; Type: DATABASE; Schema: -; Owner: catalogue
--

CREATE DATABASE "catalogue-db" WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'en_US.utf8';


ALTER DATABASE "catalogue-db" OWNER TO catalogue;

\connect -reuse-previous=on "dbname='catalogue-db'"
